...
namespace InstruLearn_Application.Model.Migrations
{
    ...
    [Migration("20250530081921_addingtablesystemconfiguration")]
    partial class addingtablesystemconfiguration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InstruLearn_Application.Model.Models.ClassFeedback", b =>
                {
            ...
            modelBuilder.Entity("InstruLearn_Application.Model.Models.ClassFeedbackEvaluation", b =>
                {
                    ...
                    b.ToTable("ClassFeedbackEvaluations");
                });
            ...
            modelBuilder.Entity("InstruLearn_Application.Model.Models.LearningRegisFeedback", b =>
                {
                    ...
                    b.Property<string>("TeacherChangeReason")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("InstruLearn_Application.Model.Models.Learning_Registration", b =>
                {
                    ...
                    b.Property<bool>("ChangeTeacherRequested")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("SentTeacherChangeReminder")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("TeacherChangeProcessed")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("InstruLearn_Application.Model.Models.Learning_Registration_Type", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RegisTypeId = 1,
                            RegisPrice = 0.00m,
                            RegisTypeName = "Đăng kí học theo yêu cầu"
                        },
                        new
                        {
                            RegisTypeId = 2,
                            RegisPrice = 0.00m,
                            RegisTypeName = "Center"
                        });
                });
            ...
            modelBuilder.Entity("InstruLearn_Application.Model.Models.LevelFeedbackCriterion", b =>
                {
                    b.Property<int>("CriterionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("LevelFeedbackCriteria");
                });

            modelBuilder.Entity("InstruLearn_Application.Model.Models.LevelFeedbackTemplate", b =>
                {
                    b.Property<int>("TemplateId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("LevelFeedbackTemplates");
                });
            ...
            modelBuilder.Entity("InstruLearn_Application.Model.Models.SelfAssessment", b =>
                {
                    b.Property<int>("SelfAssessmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InstruLearn_Application.Model.Models.SystemConfiguration", b =>
                {
            ...
            modelBuilder.Entity("InstruLearn_Application.Model.Models.TeacherEvaluationAnswer", b =>
                {
                    b.Property<int>("EvaluationAnswerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("EvaluationAnswerId"));

                    b.Property<int>("EvaluationFeedbackId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("EvaluationAnswerId");

                    b.HasIndex("EvaluationFeedbackId");

                    b.HasIndex("EvaluationQuestionId");

                    b.HasIndex("SelectedOptionId");

                    b.ToTable("TeacherEvaluationAnswers");
                });

            modelBuilder.Entity("InstruLearn_Application.Model.Models.TeacherEvaluationFeedback", b =>
                {
                    b.Property<int>("EvaluationFeedbackId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("EvaluationFeedbackId"));
                    ...
                    b.ToTable("TeacherEvaluationFeedbacks");
                });

            modelBuilder.Entity("InstruLearn_Application.Model.Models.TeacherEvaluationOption", b =>
                {
                    b.Property<int>("EvaluationOptionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("EvaluationOptionId"));
                    ...
                    b.HasKey("EvaluationOptionId");

                    b.HasIndex("EvaluationQuestionId");

                    b.ToTable("TeacherEvaluationOptions");
                });

            modelBuilder.Entity("InstruLearn_Application.Model.Models.TeacherEvaluationQuestion", b =>
                {
                    b.Property<int>("EvaluationQuestionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("EvaluationQuestionId"));
                    ...
                    b.ToTable("TeacherEvaluationQuestions");
                });
            ...
            modelBuilder.Entity("InstruLearn_Application.Model.Models.ClassFeedback", b =>
                {
                    ...
                    b.HasOne("InstruLearn_Application.Model.Models.LevelFeedbackTemplate", "Template")
                        .WithMany()
            ...
            modelBuilder.Entity("InstruLearn_Application.Model.Models.ClassFeedbackEvaluation", b =>
                {
                    b.HasOne("InstruLearn_Application.Model.Models.LevelFeedbackCriterion", "Criterion")
                        .WithMany("Evaluations")
                        .HasForeignKey("CriterionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("InstruLearn_Application.Model.Models.ClassFeedback", "Feedback")
                        .WithMany("Evaluations")
            ...
            modelBuilder.Entity("InstruLearn_Application.Model.Models.Learning_Registration", b =>
                {
                    ...
                    b.HasOne("InstruLearn_Application.Model.Models.SelfAssessment", "SelfAssessment")
                        .WithMany("LearningRegistrations")
            ...
            modelBuilder.Entity("InstruLearn_Application.Model.Models.TeacherEvaluationAnswer", b =>
                {
                    b.HasOne("InstruLearn_Application.Model.Models.TeacherEvaluationFeedback", "Feedback")
                        .WithMany("Answers")
                        .HasForeignKey("EvaluationFeedbackId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InstruLearn_Application.Model.Models.TeacherEvaluationQuestion", "Question")
                        .WithMany()
                        .HasForeignKey("EvaluationQuestionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("InstruLearn_Application.Model.Models.TeacherEvaluationOption", "SelectedOption")
                        .WithMany()
                        .HasForeignKey("SelectedOptionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("InstruLearn_Application.Model.Models.SelfAssessment", b =>
                {
                    b.Navigation("LearningRegistrations");
                });
