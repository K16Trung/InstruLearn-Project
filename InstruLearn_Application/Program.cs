...
namespace InstruLearn_Application
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddScoped<ILearningRegisFeedbackAnswerRepository, LearningRegisFeedbackAnswerRepository>();
            ...
            builder.Services.AddScoped<IGoogleSheetsService, GoogleSheetsService>(provider =>
                new GoogleSheetsService(
                    provider.GetRequiredService<IConfiguration>(),
                    provider.GetRequiredService<ILogger<GoogleSheetsService>>()
                )
            );
